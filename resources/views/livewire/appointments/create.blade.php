    ...
    <form wire:submit.prevent="store">
        <div class="row clearfix">
            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                <input class="form-control" type="text" name="username" wire:model="name" placeholder="اسمك" required="">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                <input class="form-control" type="email" name="email" wire:model="email" placeholder="البريد الالكتروني" required="">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                <label for="exampleFormControlSelect2">الدكتور</label>
                <select class="form-select"  name="doctor" wire:model="doctor" id="exampleFormControlSelect2">
            ...
            <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                <label for="exampleFormControlSelect1">ايام العمل</label>
            ...
            <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                ...
                <input type="date" name="appointment_patient" wire:model="appointment_patient" placeholder="تاريخ الموعد" class="form-control">
            </div>
