    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item" href="{{route('add_group_services')}}">{{trans('main-sidebar_trans.group_services')}}</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('single_invoice')}}">فاتورة خدمة مفردة</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('reciept.index')}}">سند قبض</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('laporatory_employee.index')}}">قائمة الموظفين</a></li>
            </ul>
        </li>
