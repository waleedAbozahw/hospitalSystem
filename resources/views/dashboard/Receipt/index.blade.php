                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('reciept.create')}}" class="btn btn-primary" role="button"
                                        ...
                                        <table class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($receipts as $receipt)
                                               <tr>
                                                   ...
                                                   <td>
                                                       <a href="{{route('reciept.edit',$receipt->id)}}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                                       ...
                                                       <a href="{{route('reciept.show',$receipt->id)}}" class="btn btn-primary btn-sm" target="_blank" title="طباعه سند قبض"><i class="fas fa-print"></i></a>
