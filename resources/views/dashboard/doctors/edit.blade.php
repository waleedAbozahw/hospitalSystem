                ...
                <form action="{{ route('doctors.update', 'test') }}" method="post" autocomplete="off"
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                        ...
                        <div class=" row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <select multiple="multiple" class="testselect2" name="work_days[]">
                                    ...
                                    @php $check = []; @endphp
                                    @foreach (explode("-", $doctor->work_days) as $key => $daysDOC)
                                    @php
                                    $check[] = $daysDOC;
                                    @endphp
                                    @endforeach
                                    <option value="{{$week}}" {{ in_array($week, $check) ? 'selected' : '' }}>{{$week}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input value="{{$doctor->number_of_statements}}" class="form-control" type="number" name="number_of_statements"></input>
                                </div>
                            </div>
                        <div class="row row-xs align-items-center mg-b-20">
                            <div class="col-md-1">
