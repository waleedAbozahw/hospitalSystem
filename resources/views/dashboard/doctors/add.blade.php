...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"> {{trans('main-sidebar_trans.doctors')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                ...
                <form action="{{ route('doctors.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <select multiple="multiple" class="testselect2" name="work_days[]">
                                    <option selected  value="" selected disabled name="work_days[]">-- حدد المواعيد --</option>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                ...
                                <input class="form-control" type="number" name="number_of_statements"></input>
