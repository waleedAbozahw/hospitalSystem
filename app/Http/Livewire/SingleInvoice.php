...
{
    public $catchError, $InvoiceSaved, $InvoiceUpdated, $show_table = true, $updateMode = false,
        $tax_rate = 17, $price, $discount_value = 0, $doctor_id, $section_id, $patient_id,
        $type, $Service_id, $single_invoice_id, $invoice_type, $invoice_id, $username;
    ...
    {
        $single_invoice = invoice::findorfail($id);
        return Redirect::route('print_single_invoice', [
